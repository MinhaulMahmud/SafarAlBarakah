...
const MakkahPage = () => (
	<div className="bg-white">
		...
		<section
			...
			style={{
				backgroundImage:
					"url('https://images.pexels.com/photos/12688735/pexels-photo-12688735.jpeg?auto=compress&cs=tinysrgb&w=1260&h=900&dpr=1')",
			}}
		>
			...
			<div className="relative z-10 flex-1 flex flex-col items-center justify-center py-8 sm:py-12 md:py-0 md:items-start md:pl-8 lg:pl-16 w-full">
				...
				>
					The holiest city in Islam, home to the Kaaba and Masjid al-Haram.
					<br className="hidden sm:block" /> Every year, millions of Muslims visit
					Makkah for Hajj and Umrah, seeking spiritual fulfillment and closeness
					to Allah.
				</motion.p>
			</div>
		...
		<section className="py-12 sm:py-20 bg-white">
			<div className="max-w-4xl mx-auto px-2 sm:px-4">
				...
				>
					Makkah Al Mukarramah, the most sacred city in Islam, is the birthplace of
					Prophet Muhammad (peace be upon him) and home to the Kaaba, the most
					revered site in Islam. Millions of Muslims from around the world visit
					Makkah annually to perform Hajj and Umrah, fulfilling a fundamental
					pillar of Islam. The city revolves around the Masjid al-Haram, the Grand
					Mosque, which houses the Kaaba, the Black Stone, and the Station of
					Ibrahim. Pilgrims perform Tawaf (circumambulation) around the Kaaba and
					Sa'i (walking between Safa and Marwah). Makkah is a city of deep
					spiritual significance, drawing believers seeking closeness to Allah.
				</motion.p>
			</div>
		</section>
	</div>
